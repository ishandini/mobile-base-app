...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( FetchRemoteConfigEvt value)?  fetch,required TResult orElse(),}){
final _that = this;
switch (_that) {
case FetchRemoteConfigEvt() when fetch != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( FetchRemoteConfigEvt value)  fetch,}){
final _that = this;
switch (_that) {
case FetchRemoteConfigEvt():
return fetch(_that);}
}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( FetchRemoteConfigEvt value)?  fetch,}){
final _that = this;
switch (_that) {
case FetchRemoteConfigEvt() when fetch != null:
return fetch(_that);case _:
...
class FetchRemoteConfigEvt implements RemoteConfigEvent {
  const FetchRemoteConfigEvt();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FetchRemoteConfigEvt);
}
