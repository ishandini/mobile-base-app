...
mixin _$ColorModel {
 ...
 String get key; String get light; String get dark;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ColorModel&&(identical(other.key, key) || other.key == key)&&(identical(other.light, light) || other.light == light)&&(identical(other.dark, dark) || other.dark == dark));
}
...
@useResult
$Res call({
 String key, String light, String dark
});
...
/// Create a copy of ColorModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? key = null,Object? light = null,Object? dark = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String key,  String light,  String dark)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ColorModel() when $default != null:
return $default(_that.key,_that.light,_that.dark);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String key,  String light,  String dark)  $default,) {final _that = this;
switch (_that) {
case _ColorModel():
return $default(_that.key,_that.light,_that.dark);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String key,  String light,  String dark)?  $default,) {final _that = this;
switch (_that) {
case _ColorModel() when $default != null:
return $default(_that.key,_that.light,_that.dark);case _:
  return null;
...
class _ColorModel extends ColorModel {
  const _ColorModel({required this.key, required this.light, required this.dark}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ColorModel&&(identical(other.key, key) || other.key == key)&&(identical(other.light, light) || other.light == light)&&(identical(other.dark, dark) || other.dark == dark));
}
...
/// Create a copy of ColorModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? key = null,Object? light = null,Object? dark = null,}) {
